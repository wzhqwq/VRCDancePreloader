...
func PipeMetaTableChange[Out any](mapFilter func(MetaChange) (Out, bool), preserved bool) *utils.EventSubscriber[Out] {
	if preserved {
		return utils.PipeEvent(preservedListEm, mapFilter)
	}
	return utils.PipeEvent(metaTableEm, mapFilter)
}

func PipeTotalSizeChange[Out any](mapFilter func(SizeChange) (Out, bool)) *utils.EventSubscriber[Out] {
	return utils.PipeEvent(totalSizeDeltaEm, mapFilter)
}
