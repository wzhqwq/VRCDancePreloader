...
const (
	minimumDataVersionKey = "minimumDataVersion"
	maximumDataVersionKey = "maximumDataVersion"
)
...
func InitCompatibility(db *sql.DB) {
	...
	minimumDataVersion = GetVersionInComp(minimumDataVersionKey, currentDataVersion)
	maximumDataVersion = GetVersionInComp(maximumDataVersionKey, currentDataVersion)
}
...
func UpgradeCompatibility() {
	SetVersionInComp(maximumDataVersionKey, currentDataVersion)
	logger.InfoLn("Upgraded database", maximumDataVersion.String(), "->", currentDataVersion.String())
	maximumDataVersion = currentDataVersion
}
